...
export const SYMBOL_SECTION_TITLE = DNA_SUBHEADING;

export const SYMBOL_METRIC = DNA_METRIC;

export const SYMBOL_METRIC_EMPHASIS = DNA_METRIC_EMPHASIS;

export const SYMBOL_METRIC_COMPACT = DNA_METRIC_COMPACT;

export const SYMBOL_CHANGE_LINE = DNA_CHANGE_LINE;

export const SYMBOL_SUBTITLE = DNA_SYMBOL_SUBTITLE;

export const SYMBOL_HEATMAP_CELL = DNA_HEATMAP_CELL;

export const SYMBOL_HEATMAP_CELL_STRIP = DNA_HEATMAP_CELL_STRIP;

export const SYMBOL_DIVIDER = "border-stone-200 dark:border-stone-700";

export const SYMBOL_MUTED_TEXT = DNA_BODY;

export const SYMBOL_LABEL = DNA_LABEL;
